...
import { addTransaction, Transactions, Updates, Delete, DeleteAllTransaction, SyncData, ViewData } from './transactions.controllers.js'
...
transactionRouter.post("/SyncData", SyncData)
